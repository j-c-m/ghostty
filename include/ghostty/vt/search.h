 ...
 *
 * Callers must serialize `ghostty_screen_search_new` with other terminal
 * mutations (same rule as selection / grid_ref). The returned handle is a
 * match snapshot and does not keep the terminal alive.
 */
 ...
 * backed by Ghostty's ScreenSearch engine. The handle is a snapshot of
 * row-local matches; it does not track later terminal changes.
 *
 * ## Examples
 *
...
/**
 * Opaque handle to a completed screen search snapshot.
 *
 * @ingroup search
 */
