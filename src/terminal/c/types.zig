...
const type_decls = [_]TypeDecl{
    ...
    .initStruct("GhosttyRenderStatePackedCell", render.PackedCell),
    .initStruct("GhosttyRenderStatePackedCells", render.PackedCells),
    ...
    .initEnum("GhosttyRenderStatePackedCellFlag", render.PackedCellFlag, "GHOSTTY_RENDER_STATE_PACKED_CELL_"),
